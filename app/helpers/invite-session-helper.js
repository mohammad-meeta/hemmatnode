 ...
 * find all dep cat data result
 */
InviteSessiontHelper.loadAllInviteSessionDataUserAll = async function loadAllInviteSessionDataUserAll(
    req,
    dataPaginate,
) {
    const page = parseInt(dataPaginate.page);
 ...
 * find all dep cat count data result
 */
InviteSessiontHelper.loadAllInviteSessionCountDataUserAll = function loadAllInviteSessionCountDataUserAll(req) {
    const InviteSession = mongoose.model("InviteSession");
    const filterQuery = {};
 ...
 * find all dep cat data result
 */
InviteSessiontHelper.loadAllInviteSessionDataUser = async function loadAllInviteSessionDataUser(
    req,
    dataPaginate,
    userid
) {
 ...
 * find all dep cat count data result
 */
InviteSessiontHelper.loadAllInviteSessionCountDataUser = function loadAllInviteSessionCountDataUser(
    req,
    group
) {
    const InviteSession = mongoose.model("InviteSession");
