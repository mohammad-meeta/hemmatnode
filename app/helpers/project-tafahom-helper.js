...
/**
 * ProjectTafahom controller
 */
function ProjectTafahomHelper() { }
module.exports = ProjectTafahomHelper;
...
ProjectTafahomHelper.loadAllProjectTafahomData = async function loadAllProjectTafahomData(req, dataPaginate, group) {
    ...
    let res = await ProjectTafahom.aggregate(pipeline);
...
ProjectTafahomHelper.loadAllProjectTafahomCountData = function loadAllProjectTafahomCountData(group) {
    ...
    return new Promise((resolve, reject) => {
        ProjectTafahom.countDocuments(filterQuery)
            .then(res => {
...
/**
 * find ProjectTafahom data result 
 */
ProjectTafahomHelper.loadProjectTafahomData = function loadProjectTafahomData(id) {
    const ProjectTafahom = mongoose.model('ProjectTafahom');
    ...
    return new Promise((resolve, reject) => {
        ProjectTafahom.findOne(filterQuery, projection, {})
            .then(res => {
                resolve(res);
            })
            .catch(err => reject(err));
...
/**
 * insert ProjectTafahom data  
 */
ProjectTafahomHelper.insertNewProjectTafahom = async function insertNewProjectTafahom(data) {

    const ProjectTafahom = mongoose.model('ProjectTafahom');
    const projectTafahom = new ProjectTafahom(data)

    let res2 = await projectTafahom.save();
    const pipeline = [
        {
            $match: {
                _id: res2._id,
...
/**
 * update ProjectTafahom data  
 */
ProjectTafahomHelper.updateProjectTafahomData = async function updateProjectTafahomData(data) {
    const ProjectTafahom = mongoose.model('ProjectTafahom');
    let res2 = await ProjectTafahom.findByIdAndUpdate(data._id, data, { useFindAndModify: false, new: true });
...
/**
 * delete projectTafahom data  
 */
ProjectTafahomHelper.deleteProjectTafahom = function deleteProjectTafahom(data) {
    return new Promise((resolve, reject) => {
        const ProjectTafahom = mongoose.model('ProjectTafahom');
        ProjectTafahom.findByIdAndUpdate(data._id, { is_active: false }, { useFindAndModify: false, new: true })
            .then(res => {
                resolve(res);
            })
            .catch(err => reject(err));
