...
Model.setup = function setup() {
    ...
    mongoose.model('Actioncreative', schema, 'actioncreatives');
};
...
Model.extraFunctions = function extraFunctions(schema) {
    schema.statics.newActioncreative = Model.newActioncreative;
 ...
 */
Model.newActioncreative = async function newActioncreative(newActioncreative) {
    let result = new this(newActioncreative);
