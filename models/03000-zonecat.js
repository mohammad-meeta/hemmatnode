...
Model.setup = function setup() {
    ...
    mongoose.model('Zonecat', schema, "zonecats");
};
...
Model.extraFunctions = function extraFunctions(schema) {
    schema.statics.newZonecat = Model.newZonecat;
 ...
 */
Model.newZonecat = function newZonecat(newZonecat) {
    let result = new this(newZonecat);
