...
>>>>>>> 13077328412bd7dcf71e4cc6f4a77366660104bc
            ...
            .field
                label.label هدف کلی (محصول پروژه)
                    .control
                        input.input(type='text', placeholder='هدف کلی (محصول پروژه)', autofocus, v-model='projectData.final_product' required)
            .field
                label.label
                    |   نحوه کاربست محصول پروژه
                .control
                    textarea.textarea(placeholder='نحوه کاربست محصول پروژه', v-model='projectData.result_apply')
            .field
                .panel
                    .panel-heading
                        | فایل های ضمیمه
