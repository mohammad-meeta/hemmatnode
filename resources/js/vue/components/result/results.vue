    ...
    .container-parent
        section.hero
            ...
            .container.page-header
                .title
                    h1(v-show="modeList") برآمد
                    h1(v-show="modeRegister") ایجاد برآمد
                    h1(v-show="modeEdit") ویرایش برآمد
        ...
        .columns.is-vcentered
            ...
            .column(v-show="!modeLoading && modeList")
                list-result(ref="resultList", @on-command="onCommand", :list-url="listUrl")

            .column(v-show="!modeLoading && modeRegister")
                register-result(ref="resultRegister", @on-command="onCommand",
                  @on-register="onResultRegister"
                  :register-url="registerUrl",
                  :projects-url="projectsUrl")

            //.column(v-show="!modeLoading && modeEdit")
                edit-result(ref="resultEdit", @on-command="onCommand",
                @on-update="onResultUpdate"
                :edit-url="editUrl",
                :projects-url="projectsUrl")

            //.column(v-show="!modeLoading && modeShow")
                show-result(ref="resultShow", @on-command="onCommand")
</template>
...
const RegisterResult = require("VUE-COMPONENTS/result/register-result.vue")
    .default;
const ListResult = require("VUE-COMPONENTS/result/list-result.vue")
    .default;
//const EditResult = require("VUE-COMPONENTS/result/edit-result.vue").default;
